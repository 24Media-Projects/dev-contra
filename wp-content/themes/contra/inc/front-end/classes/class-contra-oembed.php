...
class Contra_Embed extends BTW_Embed{
   ...
   */
    ...
    public function __construct(){
        ...
        add_filter( 'oembed_fetch_url', array( $this, 'contra_oembed_fetch_url' ), 10, 3 );
   ...
   public function contra_oembed_fetch_url( $provider, $url, $args ){
