...
class Contra_Xml_Api_Google_Showcase_Controller extends BTW_Xml_Api_Post_Controller{
 ...
 $news47_xml_api_google_showcase_controller = new Contra_Xml_Api_Google_Showcase_Controller();
