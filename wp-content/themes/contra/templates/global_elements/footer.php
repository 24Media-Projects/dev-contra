...
<footer class="global_footer <?php if (btw_is_magazine()) echo 'magazine_footer'; ?>">
    <div class="wrapper">
        <div class="global_footer__col" id="global_footer__col--contra">
            <div class="global_footer__col_section">
                <h3>Contra</h3>
                <button type="button" aria-label="Close Dropdown" class="menu-item__toggle-children" on="tap:global_footer__col--contra.toggleClass(class='open-sub-menu')"><svg>
    ...
    <div class="owner">
        <div class="owner-info">
            ...
            <p>SITE ΤΟΥ ΟΜΙΛΟΥ 24MEDIA<br> &copy; <?php echo date("Y"); ?> Contra <br> ALL RIGHTS RESERVED.<span>ΑΡΙΘΜΟΣ ΠΙΣΤΟΠΟΙΗΣΗΣ Μ.Η.Τ 242074</span><br><span>ΜΕΛΟΣ</span></p>
                <svg class="ened_logo">
