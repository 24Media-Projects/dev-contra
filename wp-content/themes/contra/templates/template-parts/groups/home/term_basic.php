...
<div class="home_wrapper term_basic__wrapper">
    <section id="<?php echo $section_id; ?>" class="term_basic_section">
        ...
        <div class="article_container">
             ...
             */
            foreach( get_field( 'btw__group_fields__hp__template__term_basic__featured_post_selection', $group_id ) ?: [] as $row ):
             ...
             * @see BTW_Atf_Post::get_atf_posts()
             */
            foreach( get_field( 'btw__group_fields__hp__template__term_basic__posts_selection', $group_id ) ?: [] as $row ):
