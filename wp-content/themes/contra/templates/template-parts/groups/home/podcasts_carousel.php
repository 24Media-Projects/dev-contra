...
<div class="home_wrapper podcast__wrapper">
    <section  id="<?php echo $section_id; ?>" class="podcast_section section_carousel">
        ...
        <div class="carusel_container loading">
            <div class="carusel_container__slider keen-slider with_dots with_arrows">
                <?php
                foreach( get_field( 'btw__group_fields__hp__template__podcasts_carousel__posts_selection', $group_id ) ?: [] as $row ):
