...
<section id="group-<?php echo $group_id; ?>" class="above_the_fold_section half_img_article">
	 ...
	 */
	foreach( get_field( 'btw__group_fields__magazine__template__above_the_fold_half_article__featured_post_selection', $group_id ) ?: [] as $key => $row ):
		...
		$atf_post = new BTW_Atf_Post_Magazine([
			...
			'render_attrs' => [
                ...
                'extra_class'      => ['above-the-fold-half-article', 'magazine_above_the_fold'],
