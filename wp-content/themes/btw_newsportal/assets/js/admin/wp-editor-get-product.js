(function($) {
  ...
  var ProductCrawler = function(options){
    ...
    this.$openModalButton = $('.product-insert-button');
    this.openModalButtonSelector = '.product-insert-button';
  ...
  ProductCrawler.prototype.parseUrl = function(e){
    ...
    this.xhr = $.post({
      ...
      success:function(data){
        ...
        self.productFields.name.val( data.ogTags.hasOwnProperty('title') ? data.ogTags.title : '' );
        self.productFields.shop_name.val( data.ogTags.hasOwnProperty('site_name') ? data.ogTags.site_name : '' );
        self.productFields.desc.val(data.ogTags.hasOwnProperty('description') ? data.ogTags.description : '');
        self.productFields.price.val(data.ogTags.hasOwnProperty('price') ? data.ogTags.price : '');
        self.productFields.img.val(data.ogTags.hasOwnProperty('image') ? data.ogTags.image : '');

        self.productFieldsCrawlValues.name = data.ogTags.hasOwnProperty('title') ? data.ogTags.title : '';
        self.productFieldsCrawlValues.shop_name =  data.ogTags.hasOwnProperty('site_name') ? data.ogTags.site_name : '';
        self.productFieldsCrawlValues.desc = data.ogTags.hasOwnProperty('description') ? data.ogTags.description : '';
        self.productFieldsCrawlValues.price = data.ogTags.hasOwnProperty('price') ? data.ogTags.price : '';
        self.productFieldsCrawlValues.img = data.ogTags.hasOwnProperty('image') ? data.ogTags.image : '';
        ...
        if(self.productFields.img.val()){
          ...
          if(  data.ogImageMeta ){
            self.$imgPreviewContainer.prepend('<div class="product__fields--img-meta">Width: ' +  ( data.ogImageMeta.width ? data.ogImageMeta.width + 'px' : ' - ' ) + ' | Height: ' +  ( data.ogImageMeta.height ? data.ogImageMeta.height + 'px' : ' - ') + ' | Mime Type: ' +  ( data.ogImageMeta.mimeType ? data.ogImageMeta.mimeType  : ' - ' ) + '</div');
            self.productFieldsCrawlValues.imgMeta = data.ogImageMeta
          }
