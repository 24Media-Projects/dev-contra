...
use News247_Posts_From_Third_Party_Api\Parsely_Posts;

class News247_Popular_Posts_Primary_Category{
 ...
 $news247_popular_posts_primary_category = new News247_Popular_Posts_Primary_Category();