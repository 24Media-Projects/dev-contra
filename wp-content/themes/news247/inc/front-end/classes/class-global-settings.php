<?php
  ...
  class BTW_Global_Settings{
    ...
    const localize_js_object_name = 'NEWS247';
    const rest_api_prefix_base = 'news247';

    const xml_api_prefix_base = 'news247';

    const TRACKING_CODE_PROVIDERS = array();

    const DEFAULT_AUTHOR_NAME = 'newsroom';
    const CLEAN_SITE_NAME = 'news247';

    const CLOUDFRONT_DOMAIN = 'media.news247.gr';
    ...
    */
    ...
    public function get_default_logo(){
      return array(
        'url' => get_template_directory_uri() . '/assets/img/logos/news247-logo.svg',
        'width' => '400',
        'height' => '126',
