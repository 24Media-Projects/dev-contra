...
class News_Two_Four_Seven_Admin_Editor{
  ...
  */
  ...
  public function wp_editor_add_editor_stylesheet(){
    ...
    $time = strtotime( 'now' );
    add_editor_style( get_stylesheet_directory_uri() .'/assets/css/admin/news247-admin-editor-styles.css?v=' . $time );

    }

  }

$news_to_four_seven_admin_editor = new News_Two_Four_Seven_Admin_Editor();
