 ...
 * and generate it with News247_Image_Editor_Watermark
 * 
 */
class News247_Og_Image{
     ...
     * A valid GD Image have to be returned ( imagecreatefrompng ) in order to use the News247_Image_Editor_Watermark
     * 
     * @return array
     */
    ...
    /**
     * Generate image using News247_Image_Editor_Watermark
     * 
     * @see News247_Image_Editor_Watermark
     * 
    ...
    private function generate_image( $image_data ){
        ...
        try{
            ...
            $og_image_gd = new News247_Image_Editor_Watermark( $image_data['file'] );
...
$news247_og_image = new News247_Og_Image();
