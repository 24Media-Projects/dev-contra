...
// Infinite Posts
require_once('inc/rest-api/class-news247-infinite-posts-rest-api.php');
require_once( 'inc/rest-api/class-news247-infinite-magazine-posts-rest-api.php' );
...
require_once( 'inc/base-api/class-news247-base-api-feeds.php' );
...
require_once('inc/front-end/classes/class-news247-amp.php');
...
add_action('after_setup_theme', function () {
	require_once( 'inc/rest-api/class-news247-videos-rest-api.php') ;
	require_once( 'inc/rest-api/class-news247-skitsa-rest-api.php' );
	require_once( 'inc/rest-api/class-news247-feeds-rest-api.php' );

	// google news feed video
	// require_once( 'inc/front-end/classes/class-google-news-feed-videos.php' );

	require_once( 'inc/xml-api/class-news247-xml-api-videos.php' );
	require_once( 'inc/xml-api/class-news247-xml-api-skitsa.php' );
	require_once( 'inc/xml-api/class-news247-xml-api-feeds.php' );
	require_once( 'inc/xml-api/class-news247-xml-api-showcase.php' );

	require_once( 'inc/front-end/classes/class-news247-oembed.php' );

});

require_once( 'inc/xml-api/xml-api-hooks.php' );

require_once( 'inc/xml-api/class-news247-xml-api-settings.php' );
...
require_once( 'inc/admin/editor/class-news247-editor.php' );
...
require_once( 'inc/front-end/classes/class-news247-parsely-post-primary-category.php' );
...
require_once( 'inc/admin/classes/class-news247-rewrite-rules.php' );
