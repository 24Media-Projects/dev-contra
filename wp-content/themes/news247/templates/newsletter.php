    ...
    <main class="legal_main newsletter_main">
        ...
        <div class="subscription_form__area">
            ...
            <div id="mc_embed_signup">
                <form
                    action="https://news247.us1.list-manage.com/subscribe/post?u=b89623a4e29393181e6283770&id=11a0ec29ff&v_id=165&f_id=00eec2e1f0"
...
-->
                        ...
                        <div id="mergeRow-gdpr" class="mc-field-group content__gdpr" style="padding-bottom: 0;">
                            ...
                            <fieldset class="mc_fieldset gdprRequired mc-field-group" name="interestgroup_field"
                                ...
                                <label class="lowercase_label checkbox subfield" for="gdpr_61">
                                    ...
                                    <span>Επιθυμώ να λαμβάνω newsletters από το News247</span>
                                </label>
                            </fieldset>
                        ...
                        <div class="form_paragraph">
                            <div class="content__gdpr">
                                <label class="lowercase_label">news247.gr</label>
                                <p>
                                    To website, News247 της εταιρείας «24MEDIA ΑΕ ψηφιακών εφαρμογών»
