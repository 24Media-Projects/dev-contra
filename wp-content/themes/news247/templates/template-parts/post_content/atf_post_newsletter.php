        ...
        <td>
            ...
            <?php if ($show_image && $image_id) : ?>
                <a class="clear post_img" style="display:block;font-size:0;" href="<?php echo $post_link; ?>" title="<?php echo $esc_post_title; ?>">
                    ...
                    <!-- <img width="600" src="https://www.news247.gr/img/9057/9527773/318000/we990/990/site_thumbnail.jpg" title="Πεθαίνοντας στα βουνά της Ελλάδας - Μια μαρτυρία γροθιά στο στομάχι" alt="Πεθαίνοντας στα βουνά της Ελλάδας - Μια μαρτυρία γροθιά στο στομάχι"> -->
                </a>
            <?php endif; ?>
        </td>
    </tr>
