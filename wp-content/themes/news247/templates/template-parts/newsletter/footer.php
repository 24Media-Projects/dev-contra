...
<tr id="templateFooterMessage">
  <td align="center" style="padding: 0 0 40px;">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapperTable">
      <tbody>
        <tr>
          <td style="font: normal normal normal 10px/12px Arial;letter-spacing: 0px;color: #000000;text-align:center;padding:0 0 5px;">SITE ΤΟΥ ΟΜΙΛΟΥ 24 MEDIA<br> © <?php echo $date_publsihed; ?> NEWS247.<br> ALL RIGHTS RESERVED</td>
        </tr>
        <tr>
