        ...
        <div class="home_wrapper clear">
            <section class="taboola_posts_container">
                <amp-embed width="100" height="100" type=taboola layout="responsive"
                    ...
                    746%"
                    data-publisher="news247-ampgr-p20801833"
                    data-mode="alternating-news247-AMP-new"
                    data-placement="Alternating Below Article New"
                    data-target_type="mix"
                    data-tracking="utm_source=News247&utm_medium=BestofNetwork_article&utm_campaign=24MediaWidget"
                    data-article="auto"
                    data-url="">
                </amp-embed>
            </section>
